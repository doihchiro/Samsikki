...
<head>
	...
	<meta charset="UTF-8">
	<title>MANAGER : 상품 조회(View)</title>
...
<body>
	<div id="root">
		...
		<section id="container">
			...
			<div class="inputArea">
				 <label for="gdsPrice">정상가격</label>
				 <span><fmt:formatNumber value="${goods.gdsPrice}" pattern="###,###,###"/></span>
			</div>
			
			<div class="inputArea">
				 <label for="salePrice">세일가격</label>
				 <span><fmt:formatNumber value="${(goods.gdsPrice*(100-goods.gdsRate))/100}" pattern="###,###,###"/></span>
			</div>

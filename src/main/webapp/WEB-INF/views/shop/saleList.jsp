...
<head>
	...
	section#content div.goodsThumb img { width:215px; height:215px; }
						...
						<c:if test="${listcheck != 'empty' }">
							...
							<li>
								<div class="goodsThumb">
									<img src="${saleList.gdsThumbImg}">
								</div>
								<div class="goodsName">
									<a href="/shop/view?n=${saleList.gdsNum}">${saleList.gdsName}</a>
								</div>
								<c:if test="${saleList.gdsRate == '0' }">
                                 <div class="goodsPrice">
                                    상품가격: <fmt:formatNumber pattern="###,###,###" value="${saleList.gdsPrice}"/> 원
                                 </div>
                                 <div>
                                 &nbsp;
                              </div>
                              ...
                              <c:if test="${saleList.gdsRate != '0' }">
                                 <div class="salePrice">
                                    할인가격: <fmt:formatNumber pattern="###,###,###" value="${(saleList.gdsPrice*(100-saleList.gdsRate))/100}"/> 원
                                    <span class="background">(<fmt:formatNumber value="${saleList.gdsRate}" />%)할인</span>
                                 </div>
                              </c:if>
	       		  	...
	       		  	<ul class="pageMaker">
		       			...
		       			<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
		       				<li class="pageMaker_btn ${pageMaker.cri.pageNum == num ? 'active':''}">
			       				<a id="atag" href="/shop/list?pageNum=${num }">${num}</a>
		       				</li>
		       			</c:forEach>

			               ...
			               <c:forEach items="${list1}" var="list1">
				               <li>
				                  	<div class="goodsThumb">
				                    	<img src="${list1.gdsThumbImg}">
				                  	</div>
				                  	<div class="goodsName">
				                     	<a href="/shop/view?n=${list1.gdsNum}">${list1.gdsName}</a>
				                  	</div>
				                  	<c:if test="${list1.gdsRate == '0' }">
                                 <div class="goodsPrice">
                                    상품가격: <fmt:formatNumber pattern="###,###,###" value="${list1.gdsPrice}"/> 원
                                 </div>
                                 <div>
                                 &nbsp;
                              </div>
                              ...
                              <c:if test="${list1.gdsRate != '0' }">
                                 <div class="salePrice">
                                    할인가격: <fmt:formatNumber pattern="###,###,###" value="${(list1.gdsPrice*(100-list1.gdsRate))/100}"/> 원
                                     <span class="background">(<fmt:formatNumber value="${list1.gdsRate}" />%)할인</span>
                                 </div>
                              </c:if>
	       		  	...
	       		  	<ul class="pageMaker">
		       			...
		       			<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
		       				<li class="pageMaker_btn ${pageMaker.cri.pageNum == num ? 'active':''}">
			       				<a id="atag" href="/shop/list1?pageNum=${num }">${num}</a>
		       				</li>
		       			</c:forEach>

					...
					<ul>
						<c:if test="${listcheck != 'empty' }">
							...
							<li>
								...
								<c:if test="${list.gdsRate == '0' }">
                                 <div class="goodsPrice">
                                    상품가격: <fmt:formatNumber pattern="###,###,###" value="${list.gdsPrice}"/> 원
                                 </div>
                                 <div>
                                 &nbsp;
                              </div>
                              ...
                              <c:if test="${list.gdsRate != '0' }">
                                 <div class="salePrice">
                                    할인가격: <fmt:formatNumber pattern="###,###,###" value="${(list.gdsPrice*(100-list.gdsRate))/100}"/> 원
                                     <span class="background">(<fmt:formatNumber value="${list.gdsRate}" />%)할인</span>
                                 </div>
                              </c:if>
